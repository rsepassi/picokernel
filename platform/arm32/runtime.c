...
__attribute__((naked)) void __aeabi_uldivmod(void) {
  __asm__ volatile("push {r4, r5, r6, r7, r8, lr}\n" // Push 6 regs (24 bytes,
                                                     // 8-byte aligned)
                   ...
                   // Prepare call: do_uldivmod_helper(r0:r1=num, r2:r3=denom,
                   // [sp]=quot, [sp+8]=rem)
                   "mov r0, r4\n"     // numerator low
                   "mov r1, r5\n"     // numerator high
                   "mov r2, r6\n"     // denominator low
...
__attribute__((used)) static void do_uidivmod_helper(uint32_t numerator,
