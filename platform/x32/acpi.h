// ACPI (Advanced Configuration and Power Interface) structures for x32
// Defines data structures for parsing ACPI tables
// x32 version uses 32-bit pointers (RSDT only, no XSDT support)
...
#define ACPI_SIG_RSDP "RSD PTR "  // Root System Description Pointer (note: 8 chars with space)
...
struct acpi_rsdp {
    ...
    uint64_t xsdt_address;   // Physical address of XSDT (64-bit) - not used in x32
